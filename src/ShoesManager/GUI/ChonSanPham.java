...
public class ChonSanPham extends javax.swing.JDialog {
    ...
    private void tblThongTinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblThongTinMouseClicked
        ...
        // không cho thêm
        tfMaGiay.setEditable(false); tfMaGiay.setEnabled(false);
        tfTenGiay.setEditable(false); tfTenGiay.setEnabled(false);
        tfSoLuong.setEditable(false); tfSoLuong.setEnabled(false);
        tfGia.setEditable(false); tfGia.setEnabled(false);
        tfSize.setEditable(false); tfSize.setEnabled(false);
        tfDoiTuongSD.setEditable(false); tfDoiTuongSD.setEnabled(false);
        tfChatLieu.setEditable(false); tfChatLieu.setEnabled(false);

        cbbThongtin_MaLoai.setEnabled(false);
        cbbThongtin_MaXX.setEnabled(false);
        cbbThongtin_MaMau.setEnabled(false);
        cbbThongtin_MaThuongHieu.setEnabled(false);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Memory.giaSP = Integer.parseInt(tfGia.getText());
        this.dispose();
    }
